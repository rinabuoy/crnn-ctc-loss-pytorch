...
def ctcloss_reference(log_probs, targets, input_lengths, target_lengths, blank=0, reduction='mean'):
    ...
    for i in range(log_probs.size(1)):
        ...
        for t in range(1, input_length):
            ...
            # к последнему элементу последовательности здесь будет находиться произведение вероятности этого элемента
            # на всю историю которая была левее него, т.е. фактически
            # это расчет стоимости пути в графе с помощью динамического программирования
